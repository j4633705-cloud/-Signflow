...
For better fidelity, especially for non-Latin scripts, build a derived image that adds Microsoft Core Fonts and additional language fonts. The signflow repository ships a reference Dockerfile at [`docker/development/Dockerfile.gotenberg`](https://github.com/signflow/signflow/blob/main/docker/development/Dockerfile.gotenberg) that you can use as a starting point:
