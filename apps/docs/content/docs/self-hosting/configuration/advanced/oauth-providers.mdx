...
description: Learn how to set up OAuth providers for your own instance of signflow.
---
...
- **Authorized JavaScript origins**: `https://<signflow-domain>`
- **Authorized redirect URIs**: `https://<signflow-domain>/api/auth/callback/google`

</Step>
<Step>
### Set environment variables

In your signflow environment, set:
...
```bash
https://<signflow-domain>/api/auth/callback/microsoft
```
