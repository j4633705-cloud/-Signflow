...
<Callout type="info">
  Review the [release notes](https://github.com/signflow/signflow/releases) before upgrading to
...
Or visit the [releases page](https://github.com/signflow/signflow/releases).
...
Read the [release notes](https://github.com/signflow/signflow/releases) carefully.
