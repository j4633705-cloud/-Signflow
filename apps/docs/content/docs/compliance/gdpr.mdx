---
title: GDPR
description: Understand how signflow handles GDPR compliance for data processing and storage.
---
...
When using signflow for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using signflow) determine the purposes and means of processing |
| **Data Processor**  | signflow processes personal data on your behalf according to your instructions       |
...
As the data processor, signflow:
...
signflow processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use signflow:

<Tabs items={['signflow Cloud', 'Self-Hosted']}>
<Tab value="signflow Cloud">
...
Contact signflow for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host signflow:

- You control all data storage locations
- No data is transmitted to signflow's infrastructure
...
- Export user and document data from your SignFlow account
- Delete user accounts and associated documents
- Contact signflow support for assistance with cloud-hosted data

## Data Deletion

signflow supports data deletion to help fulfill erasure requests:
...
Self-hosting signflow can simplify GDPR compliance:
...
- Contact [support@signflow.com](mailto:support@signflow.com) to request a DPA
- The DPA covers signflow's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with signflow is required since no personal data is processed by signflow.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use signflow, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy signflow on your own infrastructure
