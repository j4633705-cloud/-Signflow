...
<Callout type="info">
  signflow seals all signed documents cryptographically, regardless of signature level, to prevent
...
<Callout type="warn">
  Status: [Planned](https://github.com/signflow/backlog/issues/9) via third party until [Let's
  Sign](https://github.com/signflow/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/signflow/backlog/issues/32) via third party until [Let's
  Sign](https://github.com/signflow/backlog/issues/21) is realized.
</Callout>
...
## What signflow Provides

signflow supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What signflow Does Not Provide
...
<Callout type="warn">Status: [Planned](https://github.com/signflow/backlog/issues/34)</Callout>
