---
title: Manual Setup
description: Manually set up signflow on your machine for local development.
---
...
Fork the [signflow repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
npm run prisma:seed -w @signflow/prisma
```
...
Access the signflow application by visiting `http://localhost:3000` in your web browser.
