...
description: Use the demo environment to try out the signflow platform and its features.
---
...
You can use it to try out the signflow platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-app.signflow.com).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [signflow Discord](https://signflow.com/discord) or [GitHub](https://github.com/j4633705-cloud/-Signflow/issues).
