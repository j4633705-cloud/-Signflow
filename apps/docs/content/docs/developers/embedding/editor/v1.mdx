...
<Callout type="warn">
  Embedded editor is included with [Enterprise](https://signflow.com/enterprise-cta) plans. It is
  also available as a paid add-on for the [Platform Plan](https://signflow.com/platform-cta-pricing).
...
```jsx
import { EmbedCreateDocumentV1 } from '@signflow/embed-react';
...
```jsx
import { EmbedCreateTemplateV1 } from '@signflow/embed-react';
...
```jsx
import { EmbedUpdateDocumentV1 } from '@signflow/embed-react';
...
```jsx
import { EmbedUpdateTemplateV1 } from '@signflow/embed-react';
...
| `host`             | `string`  | No       | Custom host URL. Defaults to `https://app.signflow.com` |
...
| `language`         | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/j4633705-cloud/-Signflow/tree/main/packages/lib/constants/locales.ts) |
...
import { EmbedCreateDocumentV1, EmbedUpdateDocumentV1 } from '@signflow/embed-react';
