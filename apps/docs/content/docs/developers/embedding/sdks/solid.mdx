---
title: Solid
description: Embed signflow signing in your Solid application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @signflow/embed-solid ```</Tab>
  <Tab value="yarn">``` yarn add @signflow/embed-solid ```</Tab>
  <Tab value="pnpm">``` pnpm add @signflow/embed-solid ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@signflow/embed-solid';
...
```tsx
import { EmbedSignDocument } from '@signflow/embed-solid';
