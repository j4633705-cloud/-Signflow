---
title: Preact
description: Embed signflow signing in your Preact application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @signflow/embed-preact ```</Tab>
  <Tab value="yarn">``` yarn add @signflow/embed-preact ```</Tab>
  <Tab value="pnpm">``` pnpm add @signflow/embed-preact ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@signflow/embed-preact';
...
```tsx
import { EmbedSignDocument } from '@signflow/embed-preact';
