---
title: Angular
description: Embed signflow signing in your Angular application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @signflow/embed-angular ```</Tab>
  <Tab value="yarn">``` yarn add @signflow/embed-angular ```</Tab>
  <Tab value="pnpm">``` pnpm add @signflow/embed-angular ```</Tab>
</Tabs>
...
import { EmbedDirectTemplate } from '@signflow/embed-angular';
...
import { EmbedSignDocument } from '@signflow/embed-angular';
