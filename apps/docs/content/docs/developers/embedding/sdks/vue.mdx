---
title: Vue
description: Embed signflow signing in your Vue application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @signflow/embed-vue ```</Tab>
  <Tab value="yarn">``` yarn add @signflow/embed-vue ```</Tab>
  <Tab value="pnpm">``` pnpm add @signflow/embed-vue ```</Tab>
</Tabs>
...
<script setup lang="ts">
  import { EmbedDirectTemplate } from '@signflow/embed-vue';
...
```html
<script setup lang="ts">
  import { EmbedSignDocument } from '@signflow/embed-vue';
