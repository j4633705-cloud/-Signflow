...
- A signflow account on any plan (Free, Individual, Team, or Enterprise)

<Callout type="info">
  Free accounts include API access with a limit of 5 documents per month. [Upgrade to a paid
  plan](https://signflow.com/pricing) for higher limits.
</Callout>
...
- Log in to your SignFlow account
- Click your avatar in the top right corner
- Select **Settings** from the dropdown menu

![User dropdown menu](/public-api-images/signflow-user-dropdown-menu.webp)
...
![API tokens page](/public-api-images/api-tokens-page-signflow.webp)
...
![API key display](/public-api-images/signflow-api-key-blurred.webp)
...
```bash
curl https://app.signflow.com/api/v2/document \
...
signflow provides official SDKs that handle authentication for you:

```typescript
import { signflow } from '@signflow/sdk-typescript';
...
SDKs are available for [TypeScript](https://github.com/signflow/sdk-typescript), [Python](https://github.com/signflow/sdk-python), and [Go](https://github.com/signflow/sdk-go).
...
<Callout type="info">
  ...
  OpenAPI reference](https://app.signflow.com/api/v1/openapi).
</Callout>
...
SIGNFLOW_API_KEY=api_xxxxxxxxxxxxxxxx
```

```typescript
const client = new signflow({
  apiKey: process.env.SIGNFLOW_API_KEY,
});
```
