---
title: Contributing to signflow
description: Learn how to contribute to signflow and become part of our community.
---
...
This guide will help you get started with contributing to signflow.
...
Search the existing [issues](https://github.com/j4633705-cloud/-Signflow/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/j4633705-cloud/-Signflow/pulls) to see if someone else is already working on the same thing.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://signflow.com/discord).
</Callout>
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate signflow
