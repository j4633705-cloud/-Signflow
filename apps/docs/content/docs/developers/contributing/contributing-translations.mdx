...
description: Learn how to contribute translations to signflow and become part of our community.
---
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/j4633705-cloud/-Signflow/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out signflow.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie signflow.</0>"
```
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://signflow.com/discord) and ask us directly!
</Callout>

Thank you for helping make signflow more accessible to users around the world!
