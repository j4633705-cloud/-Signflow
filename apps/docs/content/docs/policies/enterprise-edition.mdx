...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate signflow into proprietary products.
---
...
- **Build proprietary products**: Integrate signflow into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to signflow source code that you don't want to disclose

<Callout type="info">
  If you run signflow without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using signflow API only        | Community Edition  |
| SaaS product with modified signflow code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed signflow in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute signflow as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    1. Acquire a license by contacting [sales](https://signflow.com/enterprise)
    2. Access your license key at [license.signflow.com](https://license.signflow.com)
    3. Set the environment variable:

    ```bash
    NEXT_PRIVATE_SIGNFLOW_LICENSE_KEY="your-license-key-here"
    ```

    4. Restart your signflow instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and signflow. Key terms include:

    - **Scope**: License to use, modify, and distribute signflow as specified in your agreement
    - **Exclusions**: The license does not grant rights to signflow trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - signflow Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or signflow Cloud      |
...
Contact [sales](https://signflow.com/enterprise) for current pricing. Enterprise agreements typically include:
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@signflow.com](https://signflow.com/enterprise)
  ...
  <Step>
    ...
    Options for evaluating signflow before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access signflow Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include signflow Cloud?">
  ...
  <Accordion title="Is there a trial period?">
    Contact [sales](https://signflow.com/enterprise) to discuss evaluation options for your
    organisation.
  </Accordion>
</Accordions>
