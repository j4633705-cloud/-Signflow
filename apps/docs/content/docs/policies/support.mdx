...
Join the signflow Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other signflow users
...
- **[GitHub Discussions](https://github.com/j4633705-cloud/-Signflow/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/j4633705-cloud/-Signflow/issues)**: Report confirmed bugs with reproducible steps
...
Paid plans include access to direct support from the signflow team.
...
- Email support at support@signflow.com
- Account and billing assistance
- Technical guidance for signflow Cloud usage
- Response during business hours

</Tab>
<Tab value="Platform and Above">

Available on [Platform plans](https://signflow.com/platform-cta-pricing) and above:

- All standard support channels
- Private Discord channel for direct communication with the signflow team
...
Contact [sales](https://signflow.com/enterprise) for Enterprise support options.
...
- [GitHub Discussions](https://github.com/j4633705-cloud/-Signflow/discussions) - Community Q&A

<Callout type="info">
  Enterprise licenses for self-hosted deployments can include dedicated support. Contact
  [sales](https://signflow.com/enterprise) for details.
</Callout>
...
- Guidance on signflow features and functionality
...
<Callout type="info">
  ...
  available separately. Contact [sales](https://signflow.com/sales) for details.
</Callout>
...
For billing disputes or account issues, email support@signflow.com with your account details.
...
signflow follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@signflow.com                                          |
| Security issues  | security@signflow.com                                         |
| Enterprise sales | [sales@signflow.com](https://signflow.com/enterprise)           |
| Privacy requests | privacy@signflow.com                                          |
| Community        | [Discord](https://signflow.com/discord)                          |
| Bug reports      | [GitHub Issues](https://github.com/j4633705-cloud/-Signflow/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How signflow handles your data
