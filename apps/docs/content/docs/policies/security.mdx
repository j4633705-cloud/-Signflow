---
title: Security
description: Security practices for signflow Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/j4633705-cloud/-Signflow](https://github.com/j4633705-cloud/-Signflow)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from signflow is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    signflow encrypts sensitive data at the application level:
...
signflow operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@signflow.com**
...
- [GitHub releases](https://github.com/j4633705-cloud/-Signflow/releases)
- [GitHub security advisories](https://github.com/j4633705-cloud/-Signflow/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/j4633705-cloud/-Signflow) for releases
...
When self-hosting signflow, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@signflow.com
- **General questions**: support@signflow.com
- **GitHub**: [github.com/j4633705-cloud/-Signflow](https://github.com/j4633705-cloud/-Signflow)
