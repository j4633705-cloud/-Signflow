---
title: Licenses
description: signflow uses a dual licensing model with an open-source AGPL-3.0 license (Community Edition) and a commercial license (Enterprise Edition).
---
...
- Use signflow for any purpose, including commercial use
- Access, study, and modify the source code
- Distribute copies of the original or modified software
- Self-host signflow on your own infrastructure

### What AGPL-3.0 Requires

The AGPL-3.0 has specific requirements that apply when you modify or distribute signflow:

**Source Code Disclosure**: If you modify signflow and make it available over a network, you must provide access to the complete source code of your modified version under AGPL-3.0.
...
<Callout type="info">
  ...
  network access as distribution. If users interact with your modified signflow instance over a
...
- Use signflow internally without modifications
...
The Enterprise Edition provides a commercial license that removes the AGPL-3.0 requirements. This allows organisations to use, modify, and integrate signflow without source code disclosure obligations.
...
**Proprietary Integration**: Integrate signflow into proprietary products and services without licensing conflicts.
...
- Build commercial products that incorporate signflow
...
<Callout type="warn">
  If you modify signflow and provide network access to users (internal or external) without
...
<Accordions type="multiple">
  <Accordion title="Do you modify signflow?">
    **No modifications**: Both licenses work. Community Edition is free and sufficient if you run signflow as-is.
  ...
  <Accordion title="Are you embedding signflow in a commercial product?">
  ...
  <Accordion title="Internal use only?">
    Using signflow internally without providing network access to external users does not trigger AGPL-3.0 distribution requirements. However, if your organisation has policies against AGPL software or you make modifications you want to keep private, consider the Enterprise Edition.
  </Accordion>
</Accordions>
...
<Accordions type="multiple">
  ...
  <Accordion title="Does using the signflow API require a commercial license?">
    No. Calling the signflow API from your application does not create a derivative work. Your
    application remains under your chosen license. However, if you modify signflow itself and
    provide network access, AGPL-3.0 requirements apply.
  </Accordion>
  <Accordion title='What counts as a "modification" under AGPL-3.0?'>
    Modifying the source code, forking the repository and making changes, or linking signflow
    libraries into your application in a way that creates a combined work. Configuration changes and
    using signflow through its API are not modifications.
  </Accordion>
  <Accordion title="Can I white-label signflow?">
  ...
  <Accordion title="What happens if I switch from Community to Enterprise Edition?">
    ...
    [sales](https://signflow.com/enterprise) to discuss migration.
  </Accordion>
  <Accordion title="Can I contribute to signflow under the Enterprise license?">
    Contributions to the main signflow repository are licensed under AGPL-3.0. The Enterprise
    license applies only to your private use and modifications.
  </Accordion>
  <Accordion title="Is there a trial for the Enterprise Edition?">
    Contact [sales](https://signflow.com/enterprise) to discuss evaluation options.
  </Accordion>
</Accordions>
...
- [GitHub Repository](https://github.com/j4633705-cloud/-Signflow) - Source code and LICENSE file
