...
The full license text is available in the [LICENSE file](https://github.com/signflow/signflow/blob/main/LICENSE) in the repository.
...
<Accordions type="multiple">
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/signflow/signflow/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/signflow/signflow/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [signflow repository](https://github.com/signflow/signflow)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/signflow/signflow/blob/main/CONTRIBUTING.md) file in the repository
