---
title: Overview
description: Organisations are the top-level entity in signflow, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in signflow's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in signflow dashboard](/organisations/organisations-create.webp)
