---
title: Email Domains
description: Learn how to create and manage email domains in signflow.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default signflow email address.
...
- Access to your signflow organisation as an admin or manager
...
After adding your domain, signflow will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the signflow email domains settings page and click the "Verify" button.
