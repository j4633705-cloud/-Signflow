...
- **Create one automatically**: signflow creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-signflow.webp)
...
```
https://app.signflow.com/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-signflow.webp)
...
If the recipient has a signflow account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public signflow profile:
...
![signflow profile with direct links](/direct-links/signflow-profile.webp)
...
```html
<a href="https://app.signflow.com/d/your-token">Sign our agreement</a>
```
