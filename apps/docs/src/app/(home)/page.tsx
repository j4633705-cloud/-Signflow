    ...
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-16 pt-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            href="/docs/users"
            className="inline-flex items-center gap-2 rounded-lg bg-signflow px-5 py-2.5 font-medium text-fd-primary-foreground text-sm transition-colors hover:bg-signflow-dark/90"
          >
            Get Started
          </Link>
          <a
