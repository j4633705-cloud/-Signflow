...
import { useSessionStorage } from '@signflow/lib/client-only/hooks/use-session-storage';
import { useCurrentOrganisation } from '@signflow/lib/client-only/providers/organisation';
import { STATS_COUNT_CAP } from '@signflow/lib/constants/document';
import { SKIP_QUERY_BATCH_META } from '@signflow/lib/constants/trpc';
import { formatAvatarUrl } from '@signflow/lib/utils/avatars';
import { parseToIntegerArray } from '@signflow/lib/utils/params';
import { formatDocumentsPath } from '@signflow/lib/utils/teams';
import { ExtendedDocumentStatus } from '@signflow/prisma/types/extended-document-status';
import { trpc } from '@signflow/trpc/react';
import type { TFindDocumentsInternalResponse } from '@signflow/trpc/server/document-router/find-documents-internal.types';
import { ZFindDocumentsInternalRequestSchema } from '@signflow/trpc/server/document-router/find-documents-internal.types';
import { Avatar, AvatarFallback, AvatarImage } from '@signflow/ui/primitives/avatar';
import type { RowSelectionState } from '@signflow/ui/primitives/data-table';
import { Tabs, TabsList, TabsTrigger } from '@signflow/ui/primitives/tabs';
...
import { ContextualTip } from '~/components/general/contextual-tip';
  ...
  return (
    <EnvelopeDropZoneWrapper type={EnvelopeType.DOCUMENT}>
      <div className="mx-auto w-full max-w-screen-xl px-4 md:px-8">
        ...
        {stats.ALL === 0 && (
          <div className="mt-4">
            <ContextualTip id="documents-empty" title="Get started with documents">
              Start by uploading your first document or creating a template.
            </ContextualTip>
          </div>
        )}
