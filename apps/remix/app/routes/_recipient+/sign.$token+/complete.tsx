...
import { isSignupEnabledForProvider } from '@signflow/lib/constants/auth';
...
import { isRecipientAuthorized } from '@signflow/lib/server-only/document/is-recipient-authorized';
...
import { DocumentShareButton } from '@signflow/ui/components/document/document-share-button';
          ...
          >
            ...
            {match({ status: signingStatus, deletedAt: document.deletedAt })
              .with({ status: 'COMPLETED' }, () => (
                <div className="mt-4 flex items-center text-center text-signflow-700">
