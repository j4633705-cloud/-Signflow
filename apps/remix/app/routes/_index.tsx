import { extractCookieFromHeaders } from '@signflow/auth/server/lib/utils/cookies';
import { getOptionalSession } from '@signflow/auth/server/lib/utils/get-session';
import { getTeams } from '@signflow/lib/server-only/team/get-teams';
import { formatDocumentsPath } from '@signflow/lib/utils/teams';
import { ZTeamUrlSchema } from '@signflow/trpc/server/team-router/schema';
