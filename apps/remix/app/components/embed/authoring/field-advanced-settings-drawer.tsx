...
import type { TFieldMetaSchema as FieldMeta } from '@signflow/lib/types/field-meta';
import { parseMessageDescriptor } from '@signflow/lib/utils/i18n';
import { FieldAdvancedSettings } from '@signflow/ui/primitives/document-flow/field-item-advanced-settings';
import { FRIENDLY_FIELD_TYPE } from '@signflow/ui/primitives/document-flow/types';
import { Sheet, SheetContent, SheetTitle } from '@signflow/ui/primitives/sheet';
