...
import { TEAM_MEMBER_ROLE_HIERARCHY } from '@signflow/lib/constants/teams';
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="z-[99999] max-w-xs text-muted-foreground">
                    <Trans>
                      ...
                      <Link
                        to="https://docs.signflow.com/users/organisations/members"
                        target="_blank"
                        rel="noreferrer"
                        className="text-signflow-700 hover:text-signflow-600 hover:underline"
                      >
                        documentation
                      </Link>
                      .
                                  ...
                                  <OrganisationMemberInviteDialog
                                    ...
                                    trigger={
                                      <Button
                                        type="button"
                                        variant="link"
                                        className="h-auto p-0 font-medium text-signflow-700 text-sm hover:text-signflow-600"
                                      >
