...
import { downloadFile } from '@signflow/lib/client-only/download-file';
import { useCurrentOrganisation } from '@signflow/lib/client-only/providers/organisation';
import { IS_BILLING_ENABLED, SUPPORT_EMAIL } from '@signflow/lib/constants/app';
...
import { ZCreateOrganisationMemberInvitesRequestSchema } from '@signflow/trpc/server/organisation-router/create-organisation-member-invites.types';
...
export const OrganisationMemberInviteDialog = ({ trigger, ...props }: OrganisationMemberInviteDialogProps) => {
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@signflow.com', role: 'Admin' },
      { email: 'manager@signflow.com', role: 'Manager' },
