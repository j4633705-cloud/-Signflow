...
import LogoImage from '@signflow/assets/logo.png';
...
import { Sheet, SheetContent } from '@signflow/ui/primitives/sheet';
import { ThemeSwitcher } from '@signflow/ui/primitives/theme-switcher';
      ...
      <SheetContent className="flex w-full max-w-[350px] flex-col">
        ...
        <div className="mt-auto flex w-full flex-col space-y-4 self-end">
          ...
          <p className="text-muted-foreground text-sm">
            Copyright {new Date().getFullYear()} SignFlow, Inc.
            <br />
