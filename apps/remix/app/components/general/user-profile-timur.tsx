...
import timurImage from '@signflow/assets/images/timur.png';
import { NEXT_PUBLIC_WEBAPP_URL } from '@signflow/lib/constants/app';
import { VerifiedIcon } from '@signflow/ui/icons/verified';
...
export const UserProfileTimur = ({ className, rows = 2 }: UserProfileTimurProps) => {
  ...
  return (
    <div className={cn('flex flex-col items-center rounded-xl bg-neutral-100 p-4 dark:bg-background', className)}>
      ...
      <div className="mt-4">
        <img src={timurImage} className="h-20 w-20 rounded-full" alt="image of timur ercan founder of signflow" />
      </div>
