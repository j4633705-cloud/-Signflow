...
import { useCurrentEnvelopeEditor } from '@signflow/lib/client-only/providers/envelope-editor-provider';
import { useCurrentOrganisation } from '@signflow/lib/client-only/providers/organisation';
import { DATE_FORMATS, DEFAULT_DOCUMENT_DATE_FORMAT } from '@signflow/lib/constants/date-formats';
import { DOCUMENT_DISTRIBUTION_METHODS, DOCUMENT_SIGNATURE_TYPES } from '@signflow/lib/constants/document';
...
import { isValidLanguageCode, SUPPORTED_LANGUAGE_CODES, SUPPORTED_LANGUAGES } from '@signflow/lib/constants/i18n';
import { DEFAULT_DOCUMENT_TIME_ZONE, TIME_ZONES } from '@signflow/lib/constants/time-zones';
import { DO_NOT_INVALIDATE_QUERY_ON_MUTATION } from '@signflow/lib/constants/trpc';
...
import { DocumentEmailEvents, ZDocumentEmailSettingsSchema } from '@signflow/lib/types/document-email';
import {
  type TDocumentMetaDateFormat,
  ZDocumentMetaDateFormatSchema,
  ZDocumentMetaTimezoneSchema,
} from '@signflow/lib/types/document-meta';
...
import { canAccessTeamDocument, DocumentSignatureType, extractTeamSignatureSettings } from '@signflow/lib/utils/teams';
import { zEmail } from '@signflow/lib/utils/zod';
import { trpc } from '@signflow/trpc/react';
import { DocumentEmailCheckboxes } from '@signflow/ui/components/document/document-email-checkboxes';
import {
  DocumentGlobalAuthAccessSelect,
  DocumentGlobalAuthAccessTooltip,
} from '@signflow/ui/components/document/document-global-auth-access-select';
import {
  DocumentGlobalAuthActionSelect,
  DocumentGlobalAuthActionTooltip,
} from '@signflow/ui/components/document/document-global-auth-action-select';
import { DocumentSendEmailMessageHelper } from '@signflow/ui/components/document/document-send-email-message-helper';
import { DocumentSignatureSettingsTooltip } from '@signflow/ui/components/document/document-signature-settings-tooltip';
import {
  DocumentVisibilitySelect,
  DocumentVisibilityTooltip,
} from '@signflow/ui/components/document/document-visibility-select';
import { ExpirationPeriodPicker } from '@signflow/ui/components/document/expiration-period-picker';
import { ReminderSettingsPicker } from '@signflow/ui/components/document/reminder-settings-picker';
import { TemplateTypeSelect, TemplateTypeTooltip } from '@signflow/ui/components/template/template-type-select';
...
import { CardDescription, CardHeader, CardTitle } from '@signflow/ui/primitives/card';
import { Combobox } from '@signflow/ui/primitives/combobox';
import {
  Dialog,
  DialogClose,
  DialogContent,
...
import { MultiSelectCombobox } from '@signflow/ui/primitives/multi-select-combobox';
...
import { Tooltip, TooltipContent, TooltipTrigger } from '@signflow/ui/primitives/tooltip';
