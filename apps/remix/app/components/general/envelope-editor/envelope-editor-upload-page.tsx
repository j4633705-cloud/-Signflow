...
import { useEnvelopeAutosave } from '@signflow/lib/client-only/hooks/use-envelope-autosave';
...
import type { TEditorEnvelope } from '@signflow/lib/types/envelope-editor';
...
import type { TReplaceEnvelopeItemPdfPayload } from '@signflow/trpc/server/envelope-router/replace-envelope-item-pdf.types';
import { buildDropzoneRejectionDescription } from '@signflow/ui/lib/handle-dropzone-rejection';
...
import { DocumentDropzone } from '@signflow/ui/primitives/document-dropzone';
