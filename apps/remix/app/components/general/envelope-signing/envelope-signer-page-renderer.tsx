...
import { usePageRenderer } from '@signflow/lib/client-only/hooks/use-page-renderer';
import {
  type PageRenderData,
  useCurrentEnvelopeRender,
} from '@signflow/lib/client-only/providers/envelope-render-provider';
import { useOptionalSession } from '@signflow/lib/client-only/providers/session';
import { DIRECT_TEMPLATE_RECIPIENT_EMAIL } from '@signflow/lib/constants/direct-templates';
import { isBase64Image } from '@signflow/lib/constants/signatures';
import type { TRecipientActionAuth } from '@signflow/lib/types/document-auth';
import type { TEnvelope } from '@signflow/lib/types/envelope';
import { ZFullFieldSchema } from '@signflow/lib/types/field';
import {
  createFieldCanvasStyleCache,
  type FieldCanvasStyleCache,
} from '@signflow/lib/universal/field-renderer/field-canvas-style';
import { createSpinner } from '@signflow/lib/universal/field-renderer/field-generic-items';
import { renderField } from '@signflow/lib/universal/field-renderer/render-field';
import { isFieldUnsignedAndRequired } from '@signflow/lib/utils/advanced-fields-helpers';
import { getClientSideFieldTranslations } from '@signflow/lib/utils/fields';
import { extractInitials } from '@signflow/lib/utils/recipient-formatter';
import type { TSignEnvelopeFieldValue } from '@signflow/trpc/server/envelope-router/sign-envelope-field.types';
import { EnvelopeRecipientFieldTooltip } from '@signflow/ui/components/document/envelope-recipient-field-tooltip';
import { EnvelopeFieldToolTip } from '@signflow/ui/components/field/envelope-field-tooltip';
