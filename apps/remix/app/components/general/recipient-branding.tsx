import type { TCssVarsSchema } from '@signflow/lib/types/css-vars';
 ...
 * `.signflow-branded` wrapper rendered in `_recipient+/_layout.tsx`.
 *
 ...
 *   }
 *
 * Equivalent to `.signflow-branded .my-class { color: red; }` after expansion.
 *
...
export const RecipientBranding = ({ branding, cspNonce }: RecipientBrandingProps) => {
  ...
  const css = `.signflow-branded { ${innerBody} }`;
