...
import communityCardsImage from '@signflow/assets/images/community-cards.png';
import { authClient } from '@signflow/auth/client';
import { useAnalytics } from '@signflow/lib/client-only/hooks/use-analytics';
import { ZNameSchema } from '@signflow/lib/constants/auth';
...
import { ZPasswordSchema } from '@signflow/trpc/server/auth-router/schema';
...
export const ZSignUpFormSchema = z
  .object({
    ...
    documentNumber: z.string().optional(), // 👈 Nova linha: Validação do CPF/CNPJ
  })
  .refine(
    (data) => {
...
export const SignUpForm = ({
  ...
  const form = useForm<TSignUpFormSchema>({
    values: {
      ...
      password: '',
      signature: '',
      documentNumber: '', // 👈 new line, initial value of the input
    },
    mode: 'onBlur',
            ...
            <fieldset className="flex w-full flex-col gap-y-4" disabled={isSubmitting}>
              ...
              <p className="mt-4 text-muted-foreground text-sm">
                <Trans>
                  ...
                  <Link to="/signin" className="text-signflow-700 duration-200 hover:opacity-70">
                    Sign in instead
                  </Link>
                </Trans>
              </p>
