import { extractSessionCookieFromHeaders } from '@signflow/auth/server/lib/session/session-cookies';
import { extractRequestMetadata, type RequestMetadata } from '@signflow/lib/universal/extract-request-metadata';
