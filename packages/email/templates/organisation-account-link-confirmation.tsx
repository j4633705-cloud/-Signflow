            ...
            <Section className="p-2 text-slate-500">
              ...
              {/* <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can unlink your account at any time in your security settings on signflow{' '}
              ...
              <Section className="mt-8 mb-6 text-center">
                <Button
                  className="inline-flex items-center justify-center rounded-lg bg-signflow-500 px-6 py-3 text-center font-medium text-black text-sm no-underline"
