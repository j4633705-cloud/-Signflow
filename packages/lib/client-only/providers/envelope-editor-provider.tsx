...
import type { TSetEnvelopeFieldsResponse } from '@signflow/trpc/server/envelope-router/set-envelope-fields.types';
import type { TSetEnvelopeRecipientsRequest } from '@signflow/trpc/server/envelope-router/set-envelope-recipients.types';
import type { TUpdateEnvelopeRequest } from '@signflow/trpc/server/envelope-router/update-envelope.types';
import type { TRecipientColor } from '@signflow/ui/lib/recipient-colors';
import { getRecipientColor } from '@signflow/ui/lib/recipient-colors';
...
export const EnvelopeEditorProvider = ({
  ...
  const _setFieldsAsync = async (localFields: TLocalField[]) => {
