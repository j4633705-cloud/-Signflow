...
const HAS_LICENSE_KEY = !!process.env.NEXT_PRIVATE_SIGNFLOW_LICENSE_KEY;

const TELEMETRY_KEY = process.env.NEXT_PRIVATE_TELEMETRY_KEY;
const TELEMETRY_HOST = process.env.NEXT_PRIVATE_TELEMETRY_HOST;
const TELEMETRY_DISABLED = !!process.env.SIGNFLOW_DISABLE_TELEMETRY || HAS_LICENSE_KEY;

const NODE_ID_FILENAME = '.signflow-node-id';
...
export class TelemetryClient {
   ...
   *
   * If telemetry is disabled via `SIGNFLOW_DISABLE_TELEMETRY=true` or credentials are not
