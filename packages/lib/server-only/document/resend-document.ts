...
import { DocumentInviteEmailTemplate } from '@signflow/email/templates/document-invite';
import { resolveExpiresAt } from '@signflow/lib/constants/envelope-expiration';
import { RECIPIENT_ROLE_TO_EMAIL_TYPE, RECIPIENT_ROLES_DESCRIPTION } from '@signflow/lib/constants/recipient-roles';
...
import { renderCustomEmailTemplate } from '@signflow/lib/utils/render-custom-email-template';
