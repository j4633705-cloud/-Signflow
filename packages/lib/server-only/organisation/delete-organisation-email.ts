...
import { OrganisationDeleteEmailTemplate } from '@signflow/email/templates/organisation-delete';
...
export const sendOrganisationDeleteEmail = async ({
  ...
  // This is sent through the global signflow mailer (the org's transport is
  // intentionally not used during deletion), so use the signflow sender to keep
