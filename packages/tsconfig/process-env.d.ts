declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_SIGNFLOW_LICENSE_KEY?: string;
    ...
    NEXT_PRIVATE_SLACK_CLIENT_ID?: string;
    NEXT_PRIVATE_SLACK_CLIENT_SECRET?: string;

    NEXT_PRIVATE_OIDC_PROMPT?: string;
    NEXT_PRIVATE_WEBHOOK_SSRF_BYPASS_HOSTS?: string;

    SIGNFLOW_DISABLE_TELEMETRY?: string;
    ...
    DANGEROUS_BYPASS_RATE_LIMITS?: string;
    E2E_TEST_AUTHENTICATE_USERNAME?: string;
    E2E_TEST_AUTHENTICATE_USER_EMAIL?: string;
    E2E_TEST_AUTHENTICATE_USER_PASSWORD?: string;
