...
import { useCopyShareLink } from '@signflow/lib/client-only/hooks/use-copy-share-link';
...
import { generateTwitterIntent } from '@signflow/lib/universal/generate-twitter-intent';
  ...
  const onTweetClick = async () => {
    ...
    window.open(
      generateTwitterIntent(
        `I just ${token ? 'signed' : 'sent'} a document in style with @signflow. Check it out!`,
      ...
      <DialogContent position="end">
        ...
        <div className="flex w-full flex-col">
          <div className="rounded-md border p-4">
            ...
            <span className="font-medium text-blue-400">@signflow</span>. Check it out!
