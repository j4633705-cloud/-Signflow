...
import { useElementBounds } from '@signflow/lib/client-only/hooks/use-element-bounds';
import { useIsPageInDom } from '@signflow/lib/client-only/hooks/use-is-page-in-dom';
import { PDF_VIEWER_PAGE_SELECTOR } from '@signflow/lib/constants/pdf-viewer';
import type { TFieldMetaSchema } from '@signflow/lib/types/field-meta';
import { ZCheckboxFieldMeta, ZRadioFieldMeta } from '@signflow/lib/types/field-meta';
      ...
      {(field.type === FieldType.RADIO || field.type === FieldType.CHECKBOX) && field.fieldMeta?.label && (
        <div
          className={cn('absolute -top-16 right-0 left-0 rounded-md p-2 text-center text-gray-700 text-xs', {
            ...
            'border border-primary bg-signflow-200': fieldHasCheckedValues,
          })}
        >
