...
import { getBoundingClientRect } from '@signflow/lib/client-only/get-bounding-client-rect';
import { useAutoSave } from '@signflow/lib/client-only/hooks/use-autosave';
import { useDocumentElement } from '@signflow/lib/client-only/hooks/use-document-element';
import { getPdfPagesCount, PDF_VIEWER_PAGE_SELECTOR } from '@signflow/lib/constants/pdf-viewer';
import { RECIPIENT_ROLES_DESCRIPTION } from '@signflow/lib/constants/recipient-roles';
import { isTemplateRecipientEmailPlaceholder } from '@signflow/lib/constants/template';
import { type TFieldMetaSchema as FieldMeta, ZFieldMetaSchema } from '@signflow/lib/types/field-meta';
import type { TRecipientLite } from '@signflow/lib/types/recipient';
import { nanoid } from '@signflow/lib/universal/id';
import { ADVANCED_FIELD_TYPES_WITH_OPTIONAL_SETTING } from '@signflow/lib/utils/advanced-fields-helpers';
import { parseMessageDescriptor } from '@signflow/lib/utils/i18n';
...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem } from '@signflow/ui/primitives/command';
import {
...
} from '@signflow/ui/primitives/document-flow/document-flow-root';
import { FieldItem } from '@signflow/ui/primitives/document-flow/field-item';
import type { DocumentFlowStep } from '@signflow/ui/primitives/document-flow/types';
import { FRIENDLY_FIELD_TYPE } from '@signflow/ui/primitives/document-flow/types';
import { Popover, PopoverContent, PopoverTrigger } from '@signflow/ui/primitives/popover';
