...
import { FIELD_SIGNATURE_META_DEFAULT_VALUES } from '@signflow/lib/types/field-meta';
import { createDocumentAuthOptions } from '@signflow/lib/utils/document-auth';
...
import { seedDirectTemplate, seedTemplate } from '@signflow/prisma/seed/templates';
import { seedTestEmail, seedUser } from '@signflow/prisma/seed/users';
...
test('[DIRECT_TEMPLATES]: use direct template link with 1 recipient', async ({ page }) => {
  ...
  await page.getByPlaceholder('recipient@signflow.com').fill(seedTestEmail());
