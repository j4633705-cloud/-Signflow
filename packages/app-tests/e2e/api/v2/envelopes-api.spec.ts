...
import { createApiToken } from '@signflow/lib/server-only/public-api/create-api-token';
...
import {
  ...
  FolderType,
  RecipientRole,
} from '@signflow/prisma/client';
import { seedUser } from '@signflow/prisma/seed/users';
import type {
  TCreateEnvelopePayload,
  TCreateEnvelopeResponse,
} from '@signflow/trpc/server/envelope-router/create-envelope.types';
import type { TCreateEnvelopeItemsPayload } from '@signflow/trpc/server/envelope-router/create-envelope-items.types';
import type { TDistributeEnvelopeRequest } from '@signflow/trpc/server/envelope-router/distribute-envelope.types';
import type { TCreateEnvelopeRecipientsRequest } from '@signflow/trpc/server/envelope-router/envelope-recipients/create-envelope-recipients.types';
import type { TUpdateEnvelopeRecipientsRequest } from '@signflow/trpc/server/envelope-router/envelope-recipients/update-envelope-recipients.types';
import type { TFindEnvelopesResponse } from '@signflow/trpc/server/envelope-router/find-envelopes.types';
import type { TGetEnvelopeResponse } from '@signflow/trpc/server/envelope-router/get-envelope.types';
import type { TUpdateEnvelopeRequest } from '@signflow/trpc/server/envelope-router/update-envelope.types';
    ...
    test('should create envelope with multiple file', async ({ request }) => {
      ...
      const payload = {
        ...
        meta: {
          ...
          redirectUrl: 'https://signflow.com',
          language: 'de',
