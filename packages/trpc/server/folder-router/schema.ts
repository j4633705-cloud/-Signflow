import { ZFolderTypeSchema } from '@signflow/lib/types/folder-type';
import { ZFindResultResponse, ZFindSearchParamsSchema } from '@signflow/lib/types/search-params';
import { DocumentVisibility } from '@signflow/prisma/generated/types';
import FolderSchema from '@signflow/prisma/generated/zod/modelSchema/FolderSchema';
import { z } from 'zod';
