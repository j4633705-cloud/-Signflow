import { ALLOWED_TEAM_GROUP_TYPES, TEAM_MEMBER_ROLE_PERMISSIONS_MAP } from '@signflow/lib/constants/teams';
import { AppError, AppErrorCode } from '@signflow/lib/errors/app-error';
import { getMemberRoles } from '@signflow/lib/server-only/team/get-member-roles';
import { generateDatabaseId } from '@signflow/lib/universal/id';
import { buildTeamWhereQuery, isTeamRoleWithinUserHierarchy } from '@signflow/lib/utils/teams';
import { prisma } from '@signflow/prisma';
import { OrganisationGroupType, OrganisationMemberRole, TeamMemberRole } from '@signflow/prisma/generated/types';
