import { adminSuperDeleteDocument } from '@signflow/lib/server-only/admin/admin-super-delete-document';
import { sendDeleteEmail } from '@signflow/lib/server-only/document/send-delete-email';
