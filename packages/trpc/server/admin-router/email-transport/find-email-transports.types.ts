import { ZEmailTransportPublicConfigSchema } from '@signflow/lib/server-only/email/email-transport-config';
import { ZFindResultResponse, ZFindSearchParamsSchema } from '@signflow/lib/types/search-params';
import EmailTransportSchema from '@signflow/prisma/generated/zod/modelSchema/EmailTransportSchema';
import { z } from 'zod';
