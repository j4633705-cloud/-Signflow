...
This document provides a high-level overview of the signflow codebase to help humans and agents understand how the application is structured.

## Overview

signflow is an open-source document signing platform built as a **monorepo** using npm workspaces and Turborepo. The application enables users to create, send, and sign documents electronically.
...
| -------------------------- | -------------------------------------------------------- | ---- |
| `@signflow/remix`         | Main application - React Router (Remix) with Hono server | 3000 |
| `@signflow/documentation` | Documentation site (Next.js + Nextra)                    | 3002 |
| `@signflow/openpage-api`  | Public analytics API                                     | 3003 |

### Core Packages (`packages/`)

| Package              | Description                                               |
| -------------------- | --------------------------------------------------------- |
| `@signflow/lib`     | Core business logic (server-only, client-only, universal) |
| `@signflow/trpc`    | tRPC API layer with OpenAPI support (API V2)              |
| `@signflow/api`     | REST API layer using ts-rest (API V1)                     |
| `@signflow/prisma`  | Database layer (Prisma ORM + Kysely)                      |
| `@signflow/ui`      | UI component library (Shadcn + Radix + Tailwind)          |
| `@signflow/email`   | Email templates and mailer (React Email)                  |
| `@signflow/auth`    | Authentication (OAuth via Arctic, WebAuthn/Passkeys)      |
| `@signflow/signing` | PDF signing (Local P12, Google Cloud KMS)                 |
| `@signflow/ee`      | Enterprise Edition features                               |
| `@signflow/assets`  | Static assets                                             |

### Supporting Packages

| Package                      | Description               |
| ---------------------------- | ------------------------- |
| `@signflow/app-tests`       | E2E tests (Playwright)    |
| `@signflow/tailwind-config` | Shared Tailwind config    |
| `@signflow/tsconfig`        | Shared TypeScript configs |
